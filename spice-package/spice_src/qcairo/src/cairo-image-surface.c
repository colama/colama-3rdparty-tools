...
{
    switch (op) {
    case CAIRO_OPERATOR_RASTER_OR:
        return PIXMAN_OP_RASTER_OR;
    case CAIRO_OPERATOR_RASTER_AND:
        return PIXMAN_OP_RASTER_AND;
    case CAIRO_OPERATOR_RASTER_XOR:
        return PIXMAN_OP_RASTER_XOR;
