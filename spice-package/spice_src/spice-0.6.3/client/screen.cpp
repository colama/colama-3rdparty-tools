...
void RedScreen::__show_full_screen()
{
    ...
    if ((monitor_size.x < _size.x) || (monitor_size.y < _size.y)) {
        LOG_INFO("Monitor Size is: %dx%d", monitor_size.x, monitor_size.y);
        LOG_INFO("Guest Size is: %dx%d", _size.x, _size.y);
