...
public:
  ...
  void sendModifierEvents(bool flag);
  // get effective modifier key
  KeySym getEffectiveModifierKey(KeySym ks);

  // TXEventHandler callback method
  virtual void handleEvent(TXWindow* w, XEvent* ev);

  void handleModPanelEvent(TXWindow* w, XEvent* ev);
...
private:
  ...
  bool altDown;
  KeySym menuKeysym;
  KeySym modPanelKeysym;
  TXMenu menu;
  TXEventHandler* menuEventHandler;
  OptionsDialog options;
  AboutDialog about;
  InfoDialog info;
  ModifierPanel modPanel;
  TXEventHandler* modPanelEventHandler;
  struct timeval modPanelTime;
