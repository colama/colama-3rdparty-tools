...
//        private Upload uploadApplet;
        ...
        public void writeFile(String name, String mimeType, 
            ...
            */
            ...
            long r = 0, cnt = 0;
            while(((r = is.read(data, 0, data.length)) != -1)) { // && uploadApplet.signalUploadThread == true) {
                //System.out.println("uploaded " + ((cnt*4*1024) + r) + " / " + fileLength);
//                uploadApplet.showFileUploadStatus("Uploaded " + ((cnt*4*1024) + r) + "/" + fileLength + " of file " + fileName);
                out.write(data, 0, (int)r);
                cnt++;
            }
            
//            if (uploadApplet.signalUploadThread == false) {
//                System.out.println("upload cancelled.");
//                uploadApplet.showFileUploadStatus("upload cancelled.");
//            }
...
//        public Upload getUploadApplet() {
//            return uploadApplet;
//        }
//
//        public void setUploadApplet(Upload uploadApplet) {
