...
class ButtonPanel extends JPanel implements ActionListener {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -902131781255147150L;
	VncViewer viewer;
	...
	public void actionPerformed(ActionEvent evt) {
		...
		if (evt.getSource() == disconnectButton) {
			...
			try {
				...
				KeyEvent ctrlAltDelEvent = new KeyEvent(this, KeyEvent.KEY_PRESSED, 0, 
						modifiers, 107, (char)0x7f);
