...
class RecordingFrame extends JFrame
  ...
  /**
	 * 
	 */
	private static final long serialVersionUID = -6001476904641772303L;
...
boolean recording;
  ...
  RecordingFrame(VncViewer v) {
    ...
    fnameField = new JTextField(fname, 64);
    ...
    JLabel helpLabel =
      new JLabel("File name to save next recorded session in:", JLabel.CENTER);
