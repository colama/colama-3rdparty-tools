...
char *fallback_resources[] = {
  ...
  "*desktop.baseTranslations:\
     <Key>F8: ShowPopup()\\n\
     <Key>Alt_L,<Key>Alt_L: ShowModifierPopup()\\n\
 ...
 "*modPanel*.orientation: XtorientHorizontal",
 "*modPanel*.allowResize: True",
 "*modPanel*.showGrip: False",
  "*modPanel.translations: #override <Message>WM_PROTOCOLS: HideModifierPopup()",
  "*modPanel.title: Modifier Key Panel",
  "*modPanel*background: grey",
  "*modPanel*font: -*-courier-medium-r-*-*-16-*-*-*-*-*-*-*",
  "*popup.buttonForm.*.borderWidth: 0",
  "*modPanel.modPanelForm.translations: #override\\n\
    <Key>Escape: HideModifierPopup()\\n\
    <Key>Alt_L: SetModifier(0)\\n\
    <Key>Alt_R: SetModifier(1)\\n\
    <Key>Control_L: SetModifier(2)\\n\
    <Key>Control_R: SetModifier(3)\\n\
    <Key>Shift_L: SetModifier(4)\\n\
    <Key>Shift_R: SetModifier(5)\\n\
    <Key>Super_L: SetModifier(6)\\n\
    <KeyPress>: SendKeyWithModifier()\\n\
    <KeyRelease>: SendKeyWithModifier()\\n",
  "*modPanel.modPanelForm.reset.translations: #override\\n\
     <Btn1Down>,<Btn1Up>: SendResetAll() HideModifierPopup()",
 "*modPanel.modPanelForm.ctrl-l.fromHoriz: alt-l",
 "*modPanel.modPanelForm.shift-l.fromHoriz: ctrl-l",
 "*modPanel.modPanelForm.alt-r.fromHoriz: shift-l",
 "*modPanel.modPanelForm.ctrl-r.fromHoriz: alt-r",
 "*modPanel.modPanelForm.shift-r.fromHoriz: ctrl-r",
 "*modPanel.modPanelForm.shift-r.fromHoriz: ctrl-r",
 "*modPanel.modPanelForm.win-l.fromHoriz: shift-r",
 "*modPanel.modPanelForm.reset.fromHoriz: win-l",
 "*modPanel.modPanelForm.transpose.fromHoriz: reset",
 "*modPanel.modPanelForm.alt-l.label: Alt-L",
 "*modPanel.modPanelForm.ctrl-l.label: Ctrl-L",
 "*modPanel.modPanelForm.shift-l.label: Shift-L",
 "*modPanel.modPanelForm.alt-r.label: Alt-R",
 "*modPanel.modPanelForm.ctrl-r.label: Ctrl-R",
 "*modPanel.modPanelForm.shift-r.label: Shift-R",
 "*modPanel.modPanelForm.win-l.label: Win",
 "*modPanel.modPanelForm.reset.label: ResetAll",
 "*modPanel.modPanelForm.transpose.label: Transpose R->L",
...
static XtActionsRec actions[] = {
    ...
    {"ShowPopup", ShowPopup},
    {"HidePopup", HidePopup},
    {"ShowModifierPopup", ShowModifierPanel},
    {"HideModifierPopup", HideModifierPanel},
    {"SetModifier", SetModifierPanelButton},
    {"SendKeyWithModifier", SendKeyWithModifier},
    {"SendResetAll", SendResetAllModifiers},
